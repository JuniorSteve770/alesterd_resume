  ...
  const projects = [
    {
      ...
      projects: [

        {
          ...
          description: "Automated trading strategies base on Indicators using API data collection, position sizing and risk management.",
          techStack: ["Python", "Machine Learning","Metatrader",  "YAhoo Finance API"],
          links: []
        },
        {
          title: "Backtesting Strategies",
          description: "Backtesting using MACD, RSI, Mean Reversion, Portfolio Optimization with Riskfolio-Lib.",
      ...
      projects: [
        {
          ...
          description: ["SABR volatility smiles using log-normal and normal models. VaR and CAViaR Risk modeling and backtesting."],
        ...
        },
        {
              ...
              description: "-	C++ for Exotic Option Pricing in C++ in Visual Studio Code Editor",
        ...
        },
        {
              ...
              links: ["https://youtu.be/b7QGe0MdypY"]
        }
      ]
    },
    {
      ...
      projects: [
        {
          ...
          description: "Automated stock data extraction from financial sources.",
        ...
        <Table bordered hover responsive className="text-center mt-2">
          <thead>
            <tr>
              ...
              <th style={{ width: '60%' }}>Project Details & Tech Stack</th>
                ...
                <tr key={`${index}-${idx}`}>
                  ...
                  <td>
                    {project.links.map((link, linkIdx) => (
                      <a key={linkIdx} href={link} className="btn btn-outline-primary btn-sm d-block mb-1" target="_blank">
